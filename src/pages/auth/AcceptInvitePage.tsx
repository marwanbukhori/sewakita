...
import { Building2, Home, Calendar, AlertTriangle, Check, FileText, Zap, Droplets, Wifi } from 'lucide-react'
        ...
        <div className="w-full max-w-sm animate-in">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-7">
            ...
            <form onSubmit={handleAuth} className="space-y-4">
              <Input label={t('auth.email_label')} type="email" required value={email}
                onChange={(e) => setEmail(e.target.value)} placeholder={t('auth.email_placeholder')} />
              <Input label={t('auth.password_label')} type="password" required value={password} minLength={6}
            ...
            <div className="text-center mt-3">
              <button onClick={() => setIsSignUp(!isSignUp)} className="text-sm text-primary-600 hover:text-primary-700 font-medium">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center"><span className="bg-white px-3 text-xs text-gray-400">{t('auth.or')}</span></div>
            </div>
